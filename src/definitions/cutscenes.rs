...
lazy_static! {
    pub static ref INTRO: VecDeque<CSEvent> = VecDeque::from([
        ...
        CSEvent::fade_in(),
        CSEvent::text_offset("I still don't know how \nthis journey started...".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I have been on this sea \nfor days, maybe weeks".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("Perhaps years.".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I need to find it...".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I need to find TOTENINSLE".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("It is said that there \nlies a secret".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("The secret of \nLife itself.".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I need to \nunderstand".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I need to \nunderst...".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I need to...".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("Wait.".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I see it".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I can finaly see \nits shores".to_string(), -64., 256. + 80.),
        CSEvent::fade_out(),
        CSEvent::Wait(1.5),
        CSEvent::Teleport("intro_dock".into()),
        CSEvent::fade_in(),
        CSEvent::text_offset("I can't believe \nI made it".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("The atmosphere, the landscape...".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("It all seems eery".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("Wait. \nHow can it be ?".to_string(), -64., 256. + 80.),
        CSEvent::text_offset("I think there's a hut over there".to_string(), -64., 256. + 80.),
        CSEvent::fade_out(),
        CSEvent::Wait(1.5),
        ...
        CSEvent::Wait(1.5),
        CSEvent::text_offset("I've been wainting\nfor you".to_string(), -92., 32.),
        CSEvent::Wait(1.5),
        ...
        CSEvent::Wait(1.5),
        CSEvent::text_offset("Powers that will help you \ndefeat Death itself".to_string(), -92., 32.),
        CSEvent::Wait(1.5),
        CSEvent::text_offset("Enter the cave. \nHere you journey trully begins".to_string(), -92., 32.),
        CSEvent::Wait(1.5),
        CSEvent::fade_out(),
        CSEvent::Wait(2.0),
